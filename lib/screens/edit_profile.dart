...
class _EditProfileState extends State<EditProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    updateDonorDetail() async {
      try {
        await donorRef.doc(widget.currentUser.id).update({
        ...
        print("Error updating donor detail: $e");
      }
    }
                  ...
                  children: <Widget>[
                    Flexible(
                      child: DropdownButtonFormField(
                        validator: (value) => value == null ? 'Please provide Blood Group' : null,
                        onChanged: (val) {
                    ...
                    Flexible(
                      child: DropdownButtonFormField(
                        validator: (value) => value == null ? 'Please provide Gender' : null,
                        onChanged: (val) {
